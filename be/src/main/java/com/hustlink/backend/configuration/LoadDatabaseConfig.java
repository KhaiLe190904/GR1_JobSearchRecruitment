...
public class LoadDatabaseConfig {
    ...
    private List<User> createUsers(UserRepository userRepository) {
        List<String> firstNames = Arrays.asList(
                ...
                "Nhu", "Phong", "Phuc", "Quan", "Quang", "Son", "Thao", "Thanh", "Thanh", "Thao",
                "Thang", "Thu", "Thu", "Trang", "Trinh", "Trung", "Tu", "Tuan", "Tuyet", "Viet",
                "Vy", "Yen", "Kim", "Ngan", "Loc", "Tien", "Khoa", "Diem", "Kiet", "Tam"
        );
        List<String> lastNames = Arrays.asList(
                "Nguyen", "Tran", "Le", "Pham", "Hoang", "Huynh", "Phan", "Vu", "Vo", "Dang",
                "Bui", "Do", "Ho", "Ngo", "Duong", "Ly", "Thai", "Mai", "Ta", "To",
                "Cao", "Chu", "La", "Lam", "Quach", "Dinh", "Trinh", "Ha", "Tang", "Trieu",
                "Vuong", "Kieu", "Thach", "Doan", "Chau", "Luu", "Giap", "Truong", "Phung", "Quan",
                "Tong", "Ngoc", "Hua", "Son", "Ta", "Tu", "Vi", "Ninh", "Dam", "Phuc"
        );

        List<String> companies = Arrays.asList("Google", "Microsoft", "Apple", "Amazon", "Meta", "Netflix", "Tesla",
                "Adobe", "X", "LinkedIn", "Spotify", "Uber", "Airbnb", "Salesforce", "Oracle", "IBM", "Intel",
                "Samsung", "Sony", "Docker", "Zoom", "Slack", "GitHub", "GitLab", "Redis", "MongoDB", "Orange",
                "Thales", "Capgemini", "Facebook", "EDF", "Algolia", "Zoho", "PayPal", "Paytm",
                "BnpParibas", "Fuji", "Canon", "Taiwan", "Yahoo", "Yelp", "Tencent", "Alibaba", "Tata", "Nvidia");
        ...
        users.addAll(List.of(
                createUser("khai@gmail.com", "khai", "Khai", "Le",
                        ...
                        null),
                createUser("hieu@gmail.com", "hieu", "Hieu", "Le",
                        positions.get(random.nextInt(positions.size())),
                        companies.get(random.nextInt(companies.size())),
                        locations.get(random.nextInt(locations.size())),
                        null),
                createUser("huy@gmail.com", "huy", "Huy", "Nguyen",
                        positions.get(random.nextInt(positions.size())),
                        companies.get(random.nextInt(companies.size())),
                        locations.get(random.nextInt(locations.size())),
                        null)));
